<!--
	ShinyText — vendored from Svelte Bits (https://sveltebits.xyz, github.com/DavidHDev/svelte-bits)
	Copyright (c) 2026 David Haz — MIT + Commons Clause (used as part of this application).
	Local adaptation: the sweep auto-disables under prefers-reduced-motion.
-->
<script lang="ts">
	type Props = {
		text: string;
